...
for ij in np.array([0,1,2,3]): 
  y0 = [0,0]
  us = integrate.odeint(f,y0,tv,args=(fvec[ij]*forcv,tv,masamodal[ij,ij],rigidezmodal[ij,ij]),rtol = 1e-6, atol=1e-8)
