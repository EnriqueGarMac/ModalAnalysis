...
class Model():
    ...
    def get_poles(self, method='lscf', show_progress=True):
        ...
        for j in tqdm_range(range(2, n+1, 2)):
            ...
            #print(np.shape(a0an1))
            # the numerator coefficients
            sr = np.roots(np.append(a0an1, 1)[::-1]) # Raíces del polinomio denominador
    ...
    def stab_chart(self, poles='all', fn_temp=0.01, xi_temp=0.05, legend=True, latex_render=False, title=None):
        """
